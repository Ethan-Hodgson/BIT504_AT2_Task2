...
public class GameMain extends JPanel implements MouseListener{
	...
	// enumeration created for state of the game
	...
	public GameMain() {   
		...
		// required event listener to 'this'
	...
	public static void main(String[] args) {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
	         public void run() {
				...
				// GameMain panel created and added to frame
				GameMain gameMainPanel = new GameMain();
				frame.add(gameMainPanel);
				
				
				// default close operation set to exit_on_close
	...
	public void paintComponent(Graphics g) {
		...
		if (currentState == GameState.Playing) {          
			...
			if (currentPlayer == Player.Cross) {   
				...
				// Statusbar to display that it is X's turn
				statusBar.setText("X's turn");
				
			} else {    
				
				// Statusbar to display that is is O's turn
	  ...
	  /** Initialise the game-board contents and the current status of GameState and Player) */
		...
		public void updateGame(Player thePlayer, int row, int col) {
			...
			if(board.hasWon(thePlayer, row, col)) {
				...
				// Check which player won and update currentstate
	...
	public void mouseClicked(MouseEvent e) {  
		...
		// repaint the graphics on the UI
			repaint();
	}
